...
define_settings_group!(TabSettings, settings: [
    ...
    show_tab_count_in_folder_header: ShowTabCountInFolderHeader {
        type: bool,
        default: true,
        supported_platforms: SupportedPlatforms::ALL,
        sync_to_cloud: SyncToCloud::Globally(RespectUserSyncSetting::Yes),
        private: false,
        toml_path: "appearance.vertical_tabs.folders.show_tab_count",
        description: "Whether to show the number of tabs next to a folder name in the vertical tabs sidebar.",
    },
